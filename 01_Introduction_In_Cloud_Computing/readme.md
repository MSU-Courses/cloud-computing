...
- [Введение В Облачные Вычисления](#введение-в-облачные-вычисления)
  ...
  - [Определение: что такое облако](#определение-что-такое-облако)
...
Формальное определение, на которое ссылаются стандарты, учебники и регуляторы, дано Национальным институтом стандартов и технологий США в документе SP 800-145[^1]. Оно короткое, и разобрать его стоит по частям.
