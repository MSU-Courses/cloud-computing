...
Мы рассмотрели виртуальные машины, но в последние годы в облачных системах огромную популярность получили _контейнеры_. _Контейнеры_ - это тоже технология изоляции и упаковки приложений, но более “лёгкого веса” по сравнению с традиционными ВМ.
...
![Рисунок 3. Сравнение архитектур: виртуализированная среда, контейнеризированная среда и контейнеризация поверх виртуализации.](../_images/02/04_virtualization_type.png)

_Рисунок 3. Сравнение архитектур: виртуализированная среда, контейнеризированная среда и контейнеризация поверх виртуализации._
