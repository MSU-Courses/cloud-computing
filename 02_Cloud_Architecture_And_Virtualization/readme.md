...
- [Архитектура облачных систем и основы виртуализации](#архитектура-облачных-систем-и-основы-виртуализации)
  ...
  - [Архитектура облачных систем: физическая vs виртуальная модель](#архитектура-облачных-систем-физическая-vs-виртуальная-модель)
  - [Виртуализация: понятие и роль в облаке](#виртуализация-понятие-и-роль-в-облаке)
  - [Гипервизор и виртуальные машины](#гипервизор-и-виртуальные-машины)
  - [Виртуализация сети (SDN) и хранилищ](#виртуализация-сети-sdn-и-хранилищ)
    - [Виртуализация сети и Software-Defined Networking](#виртуализация-сети-и-software-defined-networking)
    - [Виртуализация хранилищ](#виртуализация-хранилищ)
  - [Контейнеры и их роль в облаке](#контейнеры-и-их-роль-в-облаке)
  - [Образы контейнеров](#образы-контейнеров)
  - [Модели облачных сервисов. XaaS (Anything as a Service)](#модели-облачных-сервисов-xaas-anything-as-a-service)
    - [Основные модели облачных сервисов: IaaS, PaaS, SaaS](#основные-модели-облачных-сервисов-iaas-paas-saas)
    - [Концепция XaaS (Anything as a Service)](#концепция-xaas-anything-as-a-service)
...
Такое разделение и изоляция напрямую ведут к принципу multi-tenancy: десятки арендаторов могут использовать одну и ту же физическую инфраструктуру, но видеть только свои виртуальные машины и данные. Для каждого клиента облако выглядит так, словно оно принадлежит только ему.
...
## Модели облачных сервисов. XaaS (Anything as a Service)
