...
- [Введение в Amazon Web Services (AWS). Глобальная архитектура AWS](#введение-в-amazon-web-services-aws-глобальная-архитектура-aws)
  - [Содержание](#содержание)
  - [Вопросы для самопроверки](#вопросы-для-самопроверки)
  - [Почему мы изучаем AWS и как он связан с курсом Cloud Computing?](#почему-мы-изучаем-aws-и-как-он-связан-с-курсом-cloud-computing)
  - [Обзор платформы AWS](#обзор-платформы-aws)
    - [Основные категории сервисов AWS](#основные-категории-сервисов-aws)
  - [Глобальная инфраструктура AWS. Регионы и зоны доступности](#глобальная-инфраструктура-aws-регионы-и-зоны-доступности)
    - [Структура глобальной инфраструктуры AWS](#структура-глобальной-инфраструктуры-aws)
    - [Архитектура с несколькими регионами](#архитектура-с-несколькими-регионами)
  - [Глобальные vs. региональные сервисы AWS](#глобальные-vs-региональные-сервисы-aws)
  - [AWS аккаунты и изоляция ресурсов](#aws-аккаунты-и-изоляция-ресурсов)
  - [Управление пользователями и доступом. Использование сервиса IAM](#управление-пользователями-и-доступом-использование-сервиса-iam)
    - [IAM-пользователь](#iam-пользователь)
    - [IAM-группы](#iam-группы)
    - [IAM-роли](#iam-роли)
    - [Политики IAM](#политики-iam)
    - [Корневой пользователь (root user)](#корневой-пользователь-root-user)
  - [Основы биллинга AWS. Free Tier и модели оплаты](#основы-биллинга-aws-free-tier-и-модели-оплаты)
    - [AWS Free Tier. Бесплатный уровень](#aws-free-tier-бесплатный-уровень)
    - [On-Demand. Модель оплаты по требованию](#on-demand-модель-оплаты-по-требованию)
    - [Reserved Instances. Резервирование с предоплатой](#reserved-instances-резервирование-с-предоплатой)
    - [Spot Instances. Вычислительные ресурсы по сниженной цене](#spot-instances-вычислительные-ресурсы-по-сниженной-цене)
  - [Практическая часть. Начальные шаги в AWS](#практическая-часть-начальные-шаги-в-aws)
    - [Создание AWS аккаунта](#создание-aws-аккаунта)
    - [Вход в AWS Management Console](#вход-в-aws-management-console)
    - [Планирование бюджета и оповещения о расходах](#планирование-бюджета-и-оповещения-о-расходах)
    - [Создание IAM-пользователя](#создание-iam-пользователя)
  - [Взаимодействие с ресурсами AWS](#взаимодействие-с-ресурсами-aws)
...
![Рисунок 3. Вход в AWS Management Console](../_images/03/07_aws_login.png)

_Рисунок 3. Вход в AWS Management Console_
...
![Рисунок 4. AWS Management Console](../_images/03/09_aws_console.png)

_Рисунок 4. AWS Management Console_
...
2. Перейдите в сервис *Billing and Cost Management*.
   ![Рисунок 5. Переход в Billing and Cost Management](../_images/03/03_billing_1.png)

   _Рисунок 5. Переход в Billing and Cost Management_
3. Перейдите в раздел *Budgets*.
   ![Рисунок 6. Раздел Budgets в Billing and Cost Management](../_images/03/04_billing_2.png)

   _Рисунок 6. Раздел Budgets в Billing and Cost Management_
4. Создайте новый бюджет, нажав на кнопку *Create budget*.
   ![Рисунок 7. Создание нового бюджета](../_images/03/05_billing_3.png)

   _Рисунок 7. Создание нового бюджета_
...
8. Введите email-адреса, на которые будут отправляться уведомления при превышении бюджета (4), можно указать до 10 адресов.
   ![Рисунок 8. Настройка параметров бюджета](../_images/03/06_billing_4.png)

    _Рисунок 8. Настройка параметров бюджета_
