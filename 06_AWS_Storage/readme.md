...
- [Хранилища в облаке. Amazon S3, EBS, EFS](#хранилища-в-облаке-amazon-s3-ebs-efs)
  - [Содержание](#содержание)
  - [Вопросы для самопроверки](#вопросы-для-самопроверки)
  - [Эволюция хранения данных и вызовы традиционных моделей](#эволюция-хранения-данных-и-вызовы-традиционных-моделей)
  - [Облачное хранилище и виртуализация](#облачное-хранилище-и-виртуализация)
  - [Уровни виртуализации хранилищ](#уровни-виртуализации-хранилищ)
  - [Хранилища в AWS. История и обзор](#хранилища-в-aws-история-и-обзор)
  - [Основные категории хранилищ в AWS](#основные-категории-хранилищ-в-aws)
  - [Amazon S3](#amazon-s3)
    - [Архитектура и ключевые понятия](#архитектура-и-ключевые-понятия)
    - [Использование и сценарии хранения](#использование-и-сценарии-хранения)
    - [Региональность и доступ](#региональность-и-доступ)
    - [Неограниченная емкость](#неограниченная-емкость)
    - [Доступ к объекту S3](#доступ-к-объекту-s3)
    - [Версионирование объектов](#версионирование-объектов)
    - [Шифрование данных](#шифрование-данных)
    - [Классы хранения в S3](#классы-хранения-в-s3)
    - [Жизненный цикл объектов и переход между классами](#жизненный-цикл-объектов-и-переход-между-классами)
    - [Операции с объектами](#операции-с-объектами)
    - [Приватные и публичные бакеты](#приватные-и-публичные-бакеты)
    - [Способы доступа к S3](#способы-доступа-к-s3)
    - [Оплата и стоимость S3](#оплата-и-стоимость-s3)
    - [Расширенные возможности S3](#расширенные-возможности-s3)
  - [Amazon EBS](#amazon-ebs)
    - [Обзор и назначение](#обзор-и-назначение)
    - [Основные характеристики EBS](#основные-характеристики-ebs)
