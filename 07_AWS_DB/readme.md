...
- Все операции записи и изменения на основном инстансе синхронно реплицируются на резервный инстанс.
...
Таким образом, Subnet Group задаёт конкретные частные подсети в разных зонах, где AWS развернёт основной и резервный инстансы, обеспечивая отказоустойчивость через географическую распределённость и изоляцию сети.
