...
- [Базы данных в облаке. AWS RDS и DynamoDB](#базы-данных-в-облаке-aws-rds-и-dynamodb)
  - [Содержание](#содержание)
  - [Вопросы для самопроверки](#вопросы-для-самопроверки)
  - [Введение](#введение)
    - [Базы данных и хранилища данных](#базы-данных-и-хранилища-данных)
    - [Облачные базы данных. Зачем переносить базы данных в облако?](#облачные-базы-данных-зачем-переносить-базы-данных-в-облако)
  ...
  - [Продвинутые концепции баз данных](#продвинутые-концепции-баз-данных)
    - [Репликация](#репликация)
    - [Read и Write Replicas](#read-и-write-replicas)
    - [Шардирование](#шардирование)
  - [Базы данных в AWS](#базы-данных-в-aws)
    - [Обзор сервисов баз данных в AWS](#обзор-сервисов-баз-данных-в-aws)
    - [Managed vs Unmanaged сервисы](#managed-vs-unmanaged-сервисы)
  - [Amazon RDS](#amazon-rds)
    - [Что такое Amazon RDS?](#что-такое-amazon-rds)
    - [Зачем использовать RDS вместо установки БД на EC2](#зачем-использовать-rds-вместо-установки-бд-на-ec2)
    - [Основные компоненты Amazon RDS](#основные-компоненты-amazon-rds)
      - [Экземпляр базы данных (RDS Instance)](#экземпляр-базы-данных-rds-instance)
      - [Поддерживаемые движки баз данных](#поддерживаемые-движки-баз-данных)
      - [Типы RDS инстансов](#типы-rds-инстансов)
      - [Хранение данных в RDS](#хранение-данных-в-rds)
      - [RDS в VPC и Private Subnets](#rds-в-vpc-и-private-subnets)
      - [Subnet Groups](#subnet-groups)
    - [Репликация и высокая доступность в RDS](#репликация-и-высокая-доступность-в-rds)
      - [Multi-AZ](#multi-az)
      - [Read Replicas](#read-replicas)
    - [Автоматические бэкапы в RDS](#автоматические-бэкапы-в-rds)
    - [Сценарии использования RDS](#сценарии-использования-rds)
    - [Billing в RDS](#billing-в-rds)
  - [Amazon Aurora](#amazon-aurora)
    - [Что такое Amazon Aurora?](#что-такое-amazon-aurora)
    - [Особенности Amazon Aurora](#особенности-amazon-aurora)
  - [Amazon DynamoDB](#amazon-dynamodb)
    - [Что такое Amazon DynamoDB?](#что-такое-amazon-dynamodb)
    - [Что такое NoSQL в контексте DynamoDB](#что-такое-nosql-в-контексте-dynamodb)
    - [Основные понятия DynamoDB](#основные-понятия-dynamodb)
    - [Формат данных для загрузки в DynamoDB в виде JSON](#формат-данных-для-загрузки-в-dynamodb-в-виде-json)
    - [Операции Scan и Query в DynamoDB](#операции-scan-и-query-в-dynamodb)
    - [Использование AWS CLI для работы с DynamoDB](#использование-aws-cli-для-работы-с-dynamodb)
    - [Использование AWS SDK для работы с DynamoDB](#использование-aws-sdk-для-работы-с-dynamodb)
    - [Сценарии использования DynamoDB](#сценарии-использования-dynamodb)
  - [Amazon Redshift](#amazon-redshift)
    - [Что такое Amazon Redshift?](#что-такое-amazon-redshift)
    - [Когда использовать Amazon Redshift](#когда-использовать-amazon-redshift)
  - [Практическая часть. Создание и подключение к RDS инстансу](#практическая-часть-создание-и-подключение-к-rds-инстансу)
  - [Резюме](#резюме)
