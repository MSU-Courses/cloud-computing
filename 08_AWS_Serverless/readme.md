...
2. _Стоимость вычислений:_
   ...
   \[
   \text{Память в ГБ: } \frac{4512\text{ МБ}}{1024} = 0.5\text{ ГБ}
   \]

   \[
   \text{GB-секунды на вызов: } 0.5\text{ ГБ} \times 0.2\text{ секунды} = 0.1\text{ GB·с}
   \]

   \[
   \text{Всего GB-секунд: } 2{,}000{,}000 \times 0.1 = 200{,}000\text{ GB·с}
   \]

   \[
   \text{Стоимость: } 200{,}000\text{ GB·с находится в пределах бесплатных 400{,}000 GB·с } = \$0.00
   \]
