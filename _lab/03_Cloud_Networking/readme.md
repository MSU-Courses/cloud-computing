...
В этом шаге вы создадите три EC2-инстанса, каждый в своей роли:
...
7. Выйдите из `db-server` и `bastion-host`.

### Шаг 10. Дополнительные задания. Подключение через Bastion Host
