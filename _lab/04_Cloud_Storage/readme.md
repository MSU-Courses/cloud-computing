# Лабораторная работа №4. Amazon S3: хранение данных, работа с CLI и статическим контентом
...
- использование S3 Static Website Hosting для публичных файлов (аватары, изображения);
...
- использовать Object Ownership Enforced (современный, безопасный).
  - [Link to this variant](./advanced.md)
...
3. Проанализируйте веб-сайт, прикрепленный к данной лабораторной работе: [Сайт](./web/)
